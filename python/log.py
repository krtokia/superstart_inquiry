...
def get_logger(name=None):
    ...
    file_handler_debug = logging.FileHandler(filename="/var/www/html/python/log/log_debug.log", encoding='utf-8')
    file_handler_info = logging.FileHandler(filename="/var/www/html/python/log/"+d+".log", encoding='utf-8')
